...
*/
export type ColumnMajorTransformMatrix = [number, number, number, number, number, number];
...
export type TMaskUnits = EMaskUnits.USER_SPACE_ON_USE | EMaskUnits.OBJECT_BOUNDING_BOX;
