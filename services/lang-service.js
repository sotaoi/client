...
class LangService extends lang_contract_1.LangContract {
    constructor() {
        super(...arguments);
        this.available = null;
    ...
    init(store) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            i18next_1.default.use(react_i18next_1.initReactI18next).init({
                resources,
                lng: selectedLang === null || selectedLang === void 0 ? void 0 : selectedLang.code,
                fallbackLng: defaultLang === null || defaultLang === void 0 ? void 0 : defaultLang.code,
                interpolation: {
                    escapeValue: false,
                },
            });
