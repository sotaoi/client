...
declare class SingleCollectionField extends BaseField<any> {
    ...
    constructor(name: string, getSetState: () => (force: boolean) => void, form: BaseForm, key: string, getFormValidation: () => InputValidator<(key: string) => void | null | BaseInput<any, any>>, standardFields: {
        [key: string]: FieldConstructor | CollectionConstructor | SingleCollectionConstructor;
    }, values: {
        [key: string]: FieldConstructor | CollectionConstructor | SingleCollectionConstructor;
    });
...
declare class CollectionField extends BaseField<any> {
    ...
    constructor(name: string, getSetState: () => (force: boolean) => void, form: BaseForm, key: string, getFormValidation: () => InputValidator<(key: string) => void | null | BaseInput<any, any>>, min: null | number, max: null | number, standardFields: {
        [key: string]: FieldConstructor | CollectionConstructor | SingleCollectionConstructor;
    }, values: {
        [key: string]: FieldConstructor | CollectionConstructor | SingleCollectionConstructor;
    }[]);
