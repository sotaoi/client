...
class InputField extends base_field_1.BaseField {
    ...
    render(context) {
        ...
        if (helper_1.Helper.isMobile()) {
            ...
            const _b = context.props, { onChange } = _b, _props = __rest(_b, ["onChange"]);
            return (react_1.default.createElement(react_native_1.TextInput, Object.assign({ autoCapitalize: autoCapitalize, keyboardType: keyboardType, secureTextEntry: secureTextEntry, onChangeText: (value) => onChange({ target: { value } }) }, _props, { value: context.state.value })));
        }
