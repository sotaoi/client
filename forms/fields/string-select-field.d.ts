...
declare class StringSelectField extends BaseField<StringSelectInput, ComponentProps, ComponentState> {
    ...
    mobileRef: any;
    constructor(name: string, key: string, getFormValidation: () => InputValidator<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[] | undefined, getRerender: () => (force: boolean) => void, value: StringSelectInput);
    init(): FieldInit;
    clear(): void;
    isEmpty(): boolean;
