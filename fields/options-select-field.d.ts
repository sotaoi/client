...
declare class OptionsSelectField extends BaseField<OptionsSelectInput, ComponentProps, ComponentState> {
    options: string[];
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[] | undefined, getRerender: () => (force: boolean) => void, value: OptionsSelectInput);
    init(): FieldInit;
    clear(): void;
    isEmpty(): boolean;
