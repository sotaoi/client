...
declare class MultiFileField extends BaseField<MultiFileInput, ComponentProps, ComponentState> {
    ...
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[], getRerender: () => (force: boolean) => void, value: MultiFileInput);
    init(): FieldInit;
    clear(): void;
    isEmpty(): boolean;
