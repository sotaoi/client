...
declare abstract class BaseField<ValueType, ComponentProps = any, ComponentState = any> {
    ...
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: null | FieldValidation[], getRerender: () => (force: boolean) => void, value: ValueType);
