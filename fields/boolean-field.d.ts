...
declare class BooleanField extends BaseField<BooleanInput, ComponentProps, ComponentState> {
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[] | undefined, getRerender: () => (force: boolean) => void, value: BooleanInput);
    init(): FieldInit;
    clear(): void;
    isEmpty(): boolean;
