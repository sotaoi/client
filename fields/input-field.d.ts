...
declare class InputField<ComponentProps extends InputProps> extends BaseField<StringInput, ComponentProps, ComponentState> {
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[], getRerender: () => (force: boolean) => void, value: StringInput);
    init(): FieldInit;
