...
declare class FileField extends BaseField<FileInput, ComponentProps, ComponentState> {
    ...
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[], getRerender: () => (force: boolean) => void, value: FileInput);
    init(): FieldInit;
    clear(): void;
    isEmpty(): boolean;
