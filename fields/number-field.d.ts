...
declare class NumberField<ComponentProps = InputProps> extends BaseField<NumberInput, ComponentProps, ComponentState> {
    constructor(name: string, key: string, getFormValidation: () => InputValidatorContract<(key: string) => void | null | BaseInput<any, any>>, validations: FieldValidation[], getRerender: () => (force: boolean) => void, value: NumberInput);
    init(): FieldInit;
