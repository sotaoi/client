    ...
    action(type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const isUpdateCommand = type === 'update' && output_1.output().allowSkipUnchanged();
                helper_1.Helper.iterate(this.fields, '', output_1.output().getTouchFieldsTransformer(isUpdateCommand));
                this.setValidating(true);
                yield this.formValidation.validatePayload(this.fields, this.validations, '', type === 'update' && output_1.output().allowSkipUnchanged());
